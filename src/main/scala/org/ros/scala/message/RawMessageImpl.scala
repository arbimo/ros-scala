...
class RawMessageImpl(msg: AbsMsg) extends RawMessage {
  ...
  def getBool(p1: String): Boolean = msg.getField(p1).asInstanceOf[Boolean]

  def getBoolArray(p1: String): Array[Boolean] = msg.getField(p1).asInstanceOf[Array[Boolean]]

  def getByte(p1: String): Byte = msg.getField(p1).asInstanceOf[Byte]

  def getByteArray(p1: String): Array[Byte] = msg.getField(p1).asInstanceOf[Array[Byte]]

  def getChar(p1: String): Short = msg.getField(p1).asInstanceOf[Short]

  def getCharArray(p1: String): Array[Short] = msg.getField(p1).asInstanceOf[Array[Short]]

  def getDefinition: String = msg._DEFINITION

  def getDuration(p1: String): Duration = msg.getField(p1).asInstanceOf[Duration]

  def getDurationList(p1: String): util.List[Duration] = msg.getField(p1).asInstanceOf[util.List[Duration]]
  ...
  def getFields: util.List[Field] = {
    ...
    (for((tipe, name) <- fields) yield {
      if(PrimitiveFieldType.existsFor(tipe)) { // primitive type
        ...
        field.setValue(msg.getField(name))
        field
      }
    }).asJava
  }

  def getFloat32(p1: String): Float = msg.getField(p1).asInstanceOf[Float]

  def getFloat32Array(p1: String): Array[Float] = msg.getField(p1).asInstanceOf[Array[Float]]

  def getFloat64(p1: String): Double = msg.getField(p1).asInstanceOf[Double]

  def getFloat64Array(p1: String): Array[Double] = msg.getField(p1).asInstanceOf[Array[Double]]

  def getIdentifier: MessageIdentifier = MessageIdentifier.of(msg._TYPE)

  def getInt16(p1: String): Short = msg.getField(p1).asInstanceOf[Short]

  def getInt16Array(p1: String): Array[Short] = msg.getField(p1).asInstanceOf[Array[Short]]

  def getInt32(p1: String): Int = msg.getField(p1).asInstanceOf[Int]

  def getInt32Array(p1: String): Array[Int] = msg.getField(p1).asInstanceOf[Array[Int]]

  def getInt64(p1: String): Long = msg.getField(p1).asInstanceOf[Long]

  def getInt64Array(p1: String): Array[Long] = msg.getField(p1).asInstanceOf[Array[Long]]

  def getInt8(p1: String): Byte = msg.getField(p1).asInstanceOf[Byte]

  def getInt8Array(p1: String): Array[Byte] = msg.getField(p1).asInstanceOf[Array[Byte]]

  def getMessage[T <: message.Message](p1: String): T = msg.getField(p1).asInstanceOf[T]

  def getMessageList[T <: message.Message](p1: String): util.List[T] = msg.getField(p1).asInstanceOf[util.List[T]]
  ...
  def getString(p1: String): String = msg.getField(p1).asInstanceOf[String]

  def getStringList(p1: String): util.List[String] = msg.getField(p1).asInstanceOf[util.List[String]]

  def getTime(p1: String): Time = msg.getField(p1).asInstanceOf[Time]

  def getTimeList(p1: String): util.List[Time] = msg.getField(p1).asInstanceOf[util.List[Time]]

  def getType: String = msg._TYPE

  def getUInt16(p1: String): Short = msg.getField(p1).asInstanceOf[Short]

  def getUInt16Array(p1: String): Array[Short] = msg.getField(p1).asInstanceOf[Array[Short]]

  def getUInt32(p1: String): Int = msg.getField(p1).asInstanceOf[Int]

  def getUInt32Array(p1: String): Array[Int] = msg.getField(p1).asInstanceOf[Array[Int]]

  def getUInt64(p1: String): Long = msg.getField(p1).asInstanceOf[Long]

  def getUInt64Array(p1: String): Array[Long] = msg.getField(p1).asInstanceOf[Array[Long]]

  def getUInt8(p1: String): Short = msg.getField(p1).asInstanceOf[Short]

  def getUInt8Array(p1: String): Array[Short] = msg.getField(p1).asInstanceOf[Array[Short]]

  def getChannelBuffer(p1: String): ChannelBuffer = msg.getField(p1).asInstanceOf[ChannelBuffer]
